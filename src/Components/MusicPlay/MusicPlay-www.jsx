...
class MusicPlay extends React.Component {
    ...
    */
    ...
    playSelect = (value) => {
        ...
        localPlayList.unshift({
            ...
            name: value.name,
            img: value.al.picUrl ? this.translateHttp(value.al.picUrl) : '',
            id: value.id
        })
        this.setState({
            localPlayList
        ...
        this.setState({
            ...
            allMusicTime: '00:00',
            playProcess: 0,
            musicAuthor: value.ar[0].name,
            musicName: value.name,
            musicImg: value.al.picUrl ? this.translateHttp(value.al.picUrl) : '',
            nowId: value.id
        })
    ...
    */
    delPlayList = (index) => {
        let { localPlayList, audioPlay, nowId } = this.state
    ...
    */
    ...
    //#endregion 
    render() {
        let { showFollow, nowMusicTime, allMusicTime, audioCanPlay, audioPlay, playProcess, musciUrl, searchOpenBox,
                        ...
                        <ul>
                            {
                                searchData.length > 0 ? searchData.map((value, index) => <li
                                    ...
                                    <span className="search-music-author" title={value.ar[0].name}>{value.ar[0].name}</span>
                                </li>) : <Empty></Empty>
                            }
                        </ul>
